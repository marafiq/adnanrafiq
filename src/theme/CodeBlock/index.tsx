...
export default function CodeBlock({
    ...
    return (<React.Fragment>
        {showFooter ?
            <div className="card item shadow--sm" style={{background: `${showFooter ? '#2f2a2a' : 'none'}`}}
                 id={`card${index}`}>
                ...
                {codeBlockDesc &&
                    <div className="card__body" style={{color: `${showFooter ? 'rgb(245, 246, 247)' : ''}`}}>
                        {codeBlockDesc}
                    </div>}
